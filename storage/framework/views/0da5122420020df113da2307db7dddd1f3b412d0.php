<aside id="left-panel" class="left-panel">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-gear"></i><a href="<?php echo e(url('/admin/home')); ?>"><?php echo e(__('Home Slider')); ?></a></li>
                        </ul>
                    </li>
                   <?php endif; ?>
    ...
    </aside><?php /**PATH C:\xampp\htdocs\Script\producxpartan\resources\views/admin/navigation.blade.php ENDPATH**/ ?>