            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(__('Add Sub Category')); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                       <form action="<?php echo e(route('admin.add-subcategory')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="cat_id" class="control-label mb-1"><?php echo e(__('Category')); ?> <span class="require">*</span></label>
                                             ...
                                             <div class="form-group">
                                                <label for="subcategory_name" class="control-label mb-1"><?php echo e(__('Sub Category')); ?> <span class="require">*</span></label>
                                                <input id="subcategory_name" name="subcategory_name" type="text" class="form-control" required>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="subcategory_name" class="control-label mb-1"><?php echo e(__('Display Order')); ?></label>
...
<?php /**PATH C:\xampp\htdocs\Script\producxpartan\resources\views/admin/add-subcategory.blade.php ENDPATH**/ ?>