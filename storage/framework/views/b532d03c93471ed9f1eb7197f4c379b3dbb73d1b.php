...
<footer class="bg-dark pt-5">
    ...
    <?php endif; ?>
    <a class="btn-scroll-top" href="#top" data-scroll><span class="btn-scroll-top-tooltip text-muted font-size-sm mr-2"><?php echo e(__('Top')); ?></span><i class="btn-scroll-top-icon dwg-arrow-up"></i></a><?php /**PATH C:\xampp\htdocs\Script\producxpartan\resources\views/footer.blade.php ENDPATH**/ ?>