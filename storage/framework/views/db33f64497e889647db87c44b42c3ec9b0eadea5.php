                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(__('Title')); ?> <span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> <?php echo e(__('Display On Main Menu')); ?>?<span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> <?php echo e(__('Display On Footer Menu')); ?>?<span class="require">*</span></label>
                                           ...
                                           <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(__('Menu Order')); ?></label>
...
<?php /**PATH C:\xampp\htdocs\Script\producxpartan\resources\views/admin/add-page.blade.php ENDPATH**/ ?>