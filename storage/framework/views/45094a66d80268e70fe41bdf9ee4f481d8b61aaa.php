            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(__('Add Home Slider')); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(__('File')); ?> <span class="require">*</span></label>
                                                <input id="category_name" name="category_name" type="file" class="form-control" required>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(__('Button Link')); ?> <span class="require">*</span></label>
                                                <input id="category_name" name="category_name" type="text" class="form-control" required>
                                            </div>
...
<?php /**PATH C:\xampp\htdocs\Script\producxpartan\resources\views/admin/add-home-slider.blade.php ENDPATH**/ ?>