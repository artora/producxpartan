      ...
      <div class="navbar-sticky">
        <div class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <a class="navbar-brand d-sm-none mr-2 order-lg-1" href="{{ URL::to('/') }}" style="min-width: 4.625rem;">
             <img class="lazy" width="90" height="25" src="{{ url('/') }}/public/storage/settings/{{ $allsettings->site_logo }}"  alt="{{ $allsettings->site_title }}"/>
          </a>
          @endif
                      ...
                      <div class="widget-cart-item pb-2 mb-2 border-bottom">
                        ...
                        @endif
                          ...
                          <div class="media-body">
                            ...
                            <div class="widget-product-meta"><span class="text-accent mr-2">{{ Helper::price_format($allsettings->site_currency_position,$itemprice,"symbol") }}</span></div>
                          </div>
                        </div>
                      </div>
