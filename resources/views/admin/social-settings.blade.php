                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      <div class="form-group">
                                                ...
                                                <input id="facebook_client_id" name="facebook_client_id" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->facebook_client_id }}" data-bvalidator="required"> <small>{{ __('example') }} : 24661324324234232</small>
                                            </div>
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ __('Facebook Client Secret') }} <span class="require">*</span></label>
                                                <input id="facebook_client_secret" name="facebook_client_secret" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->facebook_client_secret }}" data-bvalidator="required"> <small>{{ __('example') }} : 5fd2de273a28f223232423424232432</small>
                                            </div>
                                 </div>
                                </div>
                             </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="facebook_callback_url" name="facebook_callback_url" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->facebook_callback_url }}" data-bvalidator="required,url"> <small>{{ __('example') }} : {{ URL::to('/') }}/login/facebook/callback</small>
                                            </div>
                             </div>
                                </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      <div class="form-group">
                                                ...
                                                <input id="google_client_id" name="google_client_id" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->google_client_id }}" data-bvalidator="required"> <small>{{ __('example') }} : 5464565465454-ups8ho3dria.apps.googleusercontent.com</small>
                                            </div>
                                             <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ __('Google Client Secret') }} <span class="require">*</span></label>
                                                <input id="google_client_secret" name="google_client_secret" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->google_client_secret }}" data-bvalidator="required"> <small>{{ __('example') }} : fwIUn323232j1-32432423YBe</small>
                                            </div>
                               </div>
                                </div>
                            </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="google_callback_url" name="google_callback_url" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->google_callback_url }}" data-bvalidator="required,url"> <small>{{ __('example') }} : {{ URL::to('/') }}/login/google/callback</small>
                                            </div>
                                        </div>
                                </div>
                             </div>
