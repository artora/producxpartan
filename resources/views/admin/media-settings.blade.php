                        ...
                        <div class="card">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="form-group">
                                                ...
                                                <option value="3" @if($setting['setting']->site_s3_storage == 3) selected @endif>{{ __('Dropbox Storage') }}</option>
                                                <option value="4" @if($setting['setting']->site_s3_storage == 4) selected @endif>{{ __('Google Storage') }}</option>
                                                </select>
                            ...
                            <div class="col-md-12"><h5>{{ __('Dropbox Storage Configuration (If dropbox storage selected)') }}</h5></div>
                            <div class="col-md-6">
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
