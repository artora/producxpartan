                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                          <div class="form-group">
                                            ...
                                            <label class="control-label mb-1">{{ __('Allowed Files') }} (jpeg, jpg, png, webp, zip, mp3, mp4)</label>
                                            </div>
                                          </div>
                                     </div>
                                 </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       ...
                                       <div id="hide_message">
                                        <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ __('Upload Thumbnail') }} ({{ __('Size') }} : 80x80px)<span class="require">*</span> </label><br/>
                                        ...
                                        @endif
                                            ...
                                            <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ __('Upload Preview') }} ({{ __('Size') }} : 361x230px)<span class="require">*</span> </label><br/>
                                        ...
                                        @endif
                                            ...
                                            <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ __('Upload Screenshots (multiple)') }} ({{ __('Size') }} : 750x430px)</label><br/>
                                        ...
                                        <small>({{ __('example') }} : https://www.youtube.com/watch?v=C0DPdy98e4c)</small>
                                            ...
                                            <div id="main_file" @if($edit['item']->file_type == 'file') class="form-group display-block" @else  class="form-group display-none" @endif>
                                                <label for="site_desc" class="control-label mb-1">{{ __('Upload Main File') }} ({{ __('ZIP - All files') }})<span class="require">*</span> </label><br/>
