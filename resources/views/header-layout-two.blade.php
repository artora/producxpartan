                                              ...
                                              @if($addition_settings->item_name_limit != 0)
                                                ...
                                                @endif
                                                     ...
                                                     <div class="product__action">
                                                       ...
                                                       <p>{{ Helper::price_format($allsettings->site_currency_position,$itemprice,"symbol") }}</p>
                                                    </div>
                                                </div>
                                               ...
                                               @endforeach 
                                                <div class="total">
                                                    <p>
                                                        <span>{{ __('Total') }} :</span>{{ Helper::price_format($allsettings->site_currency_position,$subtotall,"symbol") }}</p>
                                                </div>
                        ...
                        <div class="author-area">
                            ...
                            <div class="author-author__info inline has_dropdown removers">
                                ...
                                <div class="autor__info">
                                    ...
                                    <p class="ammount">{{ Helper::price_format($allsettings->site_currency_position,Auth::user()->earnings,"symbol") }}</p>
                                </div>
